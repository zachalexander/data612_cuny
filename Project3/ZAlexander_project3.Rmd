...
First, we can grab our initial `movie_matrix` ratings for Users 2 & 3, and then utilizing our $U$, $S$, and $V^T$ matrices, we can use the dot product to caculate predictions for these previously unknown ratings.  
```{r}
